...
| --- | --- |
| AD create academy teacher | `POST /academic-director/api/teacher-academy` |
| AD schedule lesson | `POST /academic-director/api/teacher-academy/assignments/{assignment_id}` |
| AD assess lesson | `POST /academic-director/api/teacher-academy/{academy_teacher_id}/assessments` |
| AD status update | `POST /academic-director/api/teacher-academy/{academy_teacher_id}/status` |
| AD promote | `POST /academic-director/api/teacher-academy/{academy_teacher_id}/promote` |
| AD delete | `POST /academic-director/api/teacher-academy/{academy_teacher_id}/delete` |
| HOD schedule lesson | `POST /head-of-department/api/teacher-academy/assignments/{assignment_id}` |
| HOD assess lesson | `POST /head-of-department/api/teacher-academy/{academy_teacher_id}/assessments` |
| HOD status update | `POST /head-of-department/api/teacher-academy/{academy_teacher_id}/status` |
| Shared role API response helpers | `backend/roles/common/teacher_academy_api.py` |
