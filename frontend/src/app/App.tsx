...
const pageMap = {
  ...
  "academic-director-groups": lazy(() => import("@/roles/academic_director/pages/AcademicWorkspace")),
  "academic-director-subjects": lazy(() => import("@/roles/academic_director/pages/AcademicWorkspace")),
  "academic-director-timetable": lazy(() => import("@/roles/academic_director/pages/AcademicWorkspace")),
