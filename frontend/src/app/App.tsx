...
const pageMap = {
  ...
  "head-of-departments-home": lazy(() => import("@/workspaces/head_of_department/pages/Home")),
  "head-of-departments-academy": lazy(() => import("@/workspaces/head_of_department/pages/TeacherAcademy")),
