...
export function RoleWorkspaceShell<Key extends string = string>({
  ...
  return (
    <div className="min-h-[var(--tg-viewport-height)] bg-background text-foreground">
      ...
      >
        {shouldUseDrawer ? (
          <div className="sticky top-[calc(var(--app-top-inset)+0.5rem)] z-30 mb-3 flex items-center justify-between gap-3 rounded-xl border border-border bg-surface/95 px-3 py-2 shadow-card backdrop-blur lg:hidden">
