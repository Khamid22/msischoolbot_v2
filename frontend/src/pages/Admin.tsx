...
export default function AdminPage(props: AdminPageProps) {
  ...
  return (
    <div className="min-h-[100dvh] bg-background">
      <header className="tg-fixed-topbar fixed inset-x-0 top-0 z-40 border-b border-foreground/5 bg-surface/95 backdrop-blur">
      ...
      <main className="mx-auto w-full max-w-6xl px-3 pb-[var(--safe-bottom)] pt-[calc(var(--admin-topbar-offset-mobile)+var(--safe-top))] sm:px-4 sm:pt-[calc(var(--admin-topbar-offset-desktop)+var(--safe-top))] md:px-6">
