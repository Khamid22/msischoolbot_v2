...
import { Teacher, teacherCategories, semesterStages, suggestedLessonRate, formatUzs } from "@/features/people/teachers/model";
...
export function TeacherAssignmentModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/60 p-4" role="dialog" aria-modal="true">
      <div ref={panelRef} className="flex max-h-[88dvh] w-full max-w-xl flex-col overflow-hidden rounded-lg bg-surface shadow-card-hover">
