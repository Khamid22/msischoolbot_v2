...
import { Candidate, statusLabels, candidateStatusOptions, latestCandidateEvent, formatCandidateEvent, formatCandidateEventNote } from "@/features/people/teachers/model";
