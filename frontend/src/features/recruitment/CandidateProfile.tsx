...
export function CandidateProfile({ candidateId, basePath, role, onAnnouncement }: { candidateId: number; basePath: string; role: string; onAnnouncement: (message: string, tone?: FloatingToastTone) => void }) {
