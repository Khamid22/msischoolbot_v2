...
import { AcademicDirectorPageShell, type AcademicDirectorNavKey } from "@/roles/common/components/AcademicDirectorShell";
import type { AdminTab } from "@/roles/admin/shared";
