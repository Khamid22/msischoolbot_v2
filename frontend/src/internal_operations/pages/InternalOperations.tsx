...
function InternalOperationsSidebar({
  state,
  csrfToken,
  compact = false,
  onClose,
...
export default function InternalOperationsPage(props: InternalOperationsPageProps) {
  const state = useInternalOperationsState(props);
  useDismissibleLayer({
  ...
  return (
    <div className="app-min-height bg-background lg:app-height lg:overflow-hidden">
      <InternalOperationsSidebar state={state} csrfToken={props.csrfToken} />
      ...
      >
        <div className="flex h-14 w-full items-center gap-3 px-3 sm:px-4 md:px-6">
          ...
          <div className="min-w-0 flex-1 lg:hidden">
            ...
            <p className="truncate text-[11px] text-muted-foreground">Internal Operations</p>
          </div>
