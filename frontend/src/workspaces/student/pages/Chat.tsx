        ...
        {isOwn && (
          <div className="absolute -top-1 right-0 hidden items-center gap-2 group-hover:flex group-focus-within:flex">
            <button
              type="button"
              onClick={() => onEdit(msg)}
              className="flex h-11 w-11 items-center justify-center rounded-full bg-surface shadow-card hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
              aria-label="Edit"
            >
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-surface text-destructive shadow-card hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-destructive/40"
              aria-label="Delete"
            >
