"""Compatibility wrapper for parent domain academic queries.
...
Temporary compatibility wrapper. Delete after parent academic imports migrate
to ``backend.domains.parents.queries``.
"""
