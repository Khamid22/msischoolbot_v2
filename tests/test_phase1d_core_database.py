...
from backend.modules.domains.identity import database as identity_common
...
def test_core_database_owns_connection_implementation():
    ...
    assert "from backend.modules.domains.identity.database import connect" not in core_source
