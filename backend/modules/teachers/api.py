"""Teacher HTTP API adapter.

Teacher actions call shared business modules such as office hours. They never
call another role's API or workspace implementation.
"""
...
from backend.modules.teachers.schemas import (
    AvailabilityCreated,
    AvailabilityList,
    BookingList,
...
from backend.modules.office_hours import service as oh_service
from backend.core.access import CurrentUser, get_current_user, require_role

router = APIRouter(
    prefix="/teacher/office-hours",
