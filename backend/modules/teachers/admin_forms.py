...
from backend.modules.teachers.service import (
...
from backend.modules.admin.compatibility import group_belongs_to_school
from backend.core.session import current_auth_login
from backend.modules.teacher_academy.candidates import (
