from backend.modules.academics import dates
from backend.modules.academics import schools
from backend.modules.academics import subjects
from backend.modules.academics import text
