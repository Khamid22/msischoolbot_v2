...
from backend.modules.academics.director_schemas import (
    CreateHeadOfDepartmentForm,
    HeadOfDepartmentCreated,
)
from backend.modules.academics.director_api import router as academic_router
from backend.modules.teacher_academy.director_api import register_teacher_academy_routes
from backend.modules.staff.registration import create_head_of_department_account
