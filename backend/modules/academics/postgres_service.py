...
from backend.modules.timetable import repository as timetable_repository
...
def ensure_academic_schema(conn):
    ...
    ``backend.modules.identity.bootstrap.ensure_clean_v2_schema``. A few call sites still
...
def create_student_with_enrollment(full_name, group_id):
    ...
    """
    from backend.modules.identity.accounts import provision_student_account
