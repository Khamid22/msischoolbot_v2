...
from backend.modules.academics.canonical import (
...
def compute_subject_rating(student_id, payload, dataset=None):
    ...
    if not dashboards:
        from backend.modules.academics.internal_dashboard_service import get_subject_dashboards_from_db
...
def load_dataset(school_code=None, force_refresh=False):
    from backend.modules.academics.internal_dashboard_service import build_internal_dataset
...
def load_dashboard_payload(
    ...
    from backend.modules.academics.internal_dashboard_service import get_enrollment_dashboard
