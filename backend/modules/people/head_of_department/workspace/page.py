...
from backend.modules.people.head_of_department.contracts import (
    current_auth_login,
    current_auth_role,
    current_staff_id,
...
def register_head_of_department_recruitment_page_routes(app):
    register_head_of_department_recruitment_routes(app)
