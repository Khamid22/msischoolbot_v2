...
from backend.modules.accounts.service import reset_student_password

from backend.modules.student_records import repository
from backend.modules.staff_records.teachers_service import get_teacher_name_by_group
from backend.modules.accounts.database import (
    DB_LOCK as _DB_LOCK,
    connect as _connect,
...
def resolve_student_for_internal_operations(student_row_id, get_admin_student_profile):
