...
from backend.modules.teachers import repository as teacher_repository
# Teacher identity helpers remain owned by the canonical teacher domain.
get_teacher_by_full_name_row = teacher_repository.get_teacher_by_full_name_row
insert_teacher_profile_row = teacher_repository.insert_teacher_profile_row
upsert_teacher_subject = teacher_repository.upsert_teacher_subject
get_teacher_auth_row_by_id = teacher_repository.get_teacher_auth_row_by_id
get_next_teacher_code = teacher_repository.get_next_teacher_code
insert_teacher_auth = teacher_repository.insert_teacher_auth
activate_teacher_profile = teacher_repository.activate_teacher_profile
set_teacher_group_assignment = teacher_repository.set_teacher_group_assignment
...
def insert_teacher_account_for_provisioning(
    ...
    inserted = conn.execute(
        ...
        VALUES (%s, %s, 'teacher', 'active', %s, 'msi_staff', %s, true, 1, %s::timestamptz, %s::timestamptz)
        RETURNING id
        """,
