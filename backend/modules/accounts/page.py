...
from backend.modules.accounts.service import authenticate_account_password
from backend.modules.accounts.telegram_auth import authenticate_account_telegram
