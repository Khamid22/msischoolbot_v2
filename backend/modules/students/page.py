...
from backend.modules.students.dashboard_page import register_dashboard_routes
from backend.modules.students.rating_page import register_rating_board_routes
from backend.modules.students.chat_page import register_chat_page_routes
from backend.modules.students.resources_page import register_resources_routes
from backend.modules.students.office_hours_page import register_office_hours_routes
from backend.modules.students.service import (
    get_student_db_id_by_enrollment_id,
    record_student_activity,
)
from backend.modules.students.workspace import build_student_panel_context
...
from backend.modules.students.forms import register_student_routes
