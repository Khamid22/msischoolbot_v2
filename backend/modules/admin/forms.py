from backend.modules.resources.admin_forms import register_admin_resource_routes
from backend.modules.students.admin_forms import register_admin_student_routes
from backend.modules.teachers.admin_forms import register_admin_teacher_routes
