...
from backend.modules.domains.identity.passwords import generate_password_hash, verify_password_hash
from backend.modules.domains.organization.canonical import normalize_school_code
from backend.modules.domains.identity import repository
from backend.modules.domains.identity.contracts import (
    ProvisionStudentAccountCommand,
    provision_student_account as provision_student_account_contract,
)
from backend.modules.domains.identity.database import DB_LOCK, connect
...
def provision_student_account(
    ...
    *,
    ...
    result = provision_student_account_contract(
        conn,
        ProvisionStudentAccountCommand(
