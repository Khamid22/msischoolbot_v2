...
from backend.modules.domains.identity.schemas import PasswordChangeRequest, PasswordChangeResult, TelegramLinkRequest
from backend.modules.domains.identity.service import change_own_password
