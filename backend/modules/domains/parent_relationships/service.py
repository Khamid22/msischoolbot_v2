...
from backend.modules.domains.finance.service import (
    list_student_payments,
    payment_summary_for_student,
    summarize_payment_records,
)
from backend.modules.domains.parent_relationships import repository as parent_repository
...
def create_parent_invite_code(
    ...
    *,
    ...
    with _connect() as conn:
        result = create_parent_invite(
            conn,
            CreateParentInviteCommand(
                legacy_student_row_id=student_row_id,
                issued_by_staff_id=issued_by,
