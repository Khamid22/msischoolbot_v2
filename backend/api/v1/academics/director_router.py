...
from backend.api.v1.academics.director import router as academic_router
from backend.api.v1.teacher_academy.director import register_teacher_academy_routes
from backend.services.staff.registration import create_head_of_department_account
