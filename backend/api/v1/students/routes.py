...
from backend.api.v1.students.activity import router as activity_router
from backend.api.v1.students.chat import router as chat_router
from backend.api.v1.students.comments import router as comments_router
from backend.api.v1.students.office_hours import router as office_hours_router
