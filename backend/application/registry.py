...
from backend.modules.domains.admissions.page import register_admission_page_routes
...
from backend.modules.people.customer_support.workspace.page import (
...
WORKSPACES = (
    ...
    WorkspaceSpec("public_admission", register_admission_page_routes),
)
