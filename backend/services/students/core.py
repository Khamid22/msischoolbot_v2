...
from backend.services.identity.accounts import reset_student_password

from backend.repositories import students as repository
from backend.services.teachers.core import get_teacher_name_by_group
from backend.services.identity.database import (
    DB_LOCK as _DB_LOCK,
    connect as _connect,
