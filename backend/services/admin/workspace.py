...
from backend.repositories import admin as repository
from backend.services.academics import canonical
from backend.services.admin.page_cache import (
...
from backend.services.students.core import get_admin_student_profile, list_students_for_admin
from backend.services.teachers.core import list_teachers
from backend.services.teacher_academy.core import list_academy_teachers
from backend.services.teacher_academy.candidates import list_teacher_candidates
from backend.services.complaints.core import list_complaints
from backend.services.academics.canonical import normalize_text
from backend.services.parents.core import list_parent_accounts, list_parent_children
from backend.services.academics.performance_summary import (
    list_subject_group_counts,
    list_subject_student_counts,
    list_subject_summaries,
)
from backend.services.academics.internal_dashboard import build_internal_overview_dataset

from backend.services.academics.insights import (
...
from backend.services.resources.core import (
