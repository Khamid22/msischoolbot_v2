...
from backend.repositories import timetable as timetable_repository
...
def ensure_academic_schema(conn):
    ...
    ``backend.services.identity.bootstrap.ensure_clean_v2_schema``. A few call sites still
...
def create_student_with_enrollment(full_name, group_id):
    ...
    """
    from backend.services.identity.accounts import provision_student_account
