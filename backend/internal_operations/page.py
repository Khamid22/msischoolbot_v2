...
from backend.internal_operations.academic_forms import register_academic_admin_routes
from backend.internal_operations.forms import register_admin_routes
from backend.internal_operations.workspace import (
