...
from backend.services.teachers.core import (
...
from backend.services.admin.compatibility import group_belongs_to_school
from backend.core.session import current_auth_login
from backend.services.teacher_academy.candidates import (
