...
from backend.pages.parent import build_render_parent_page
from backend.pages.student_dashboard import register_dashboard_routes
from backend.pages.student_rating_board import register_rating_board_routes
from backend.pages.student_chat import register_chat_page_routes
from backend.pages.student_resources import register_resources_routes
from backend.pages.student_office_hours import register_office_hours_routes
...
from backend.pages.student_forms import register_student_routes
