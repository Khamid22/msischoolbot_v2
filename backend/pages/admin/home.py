...
from backend.pages.admin.academic_forms import register_academic_admin_routes
from backend.pages.admin.forms import register_admin_routes
from backend.services.admin.workspace import (
...
from backend.services.academics.operations import list_admin_academic_context
from backend.services.parents.core import list_linked_parents_for_student
    ...
    *,
    ...
    def render_admin_page(
        ...
        if current_auth_role() == "head_of_department":
            from backend.services.teacher_academy.permissions import filter_admin_context_for_hod_scope
