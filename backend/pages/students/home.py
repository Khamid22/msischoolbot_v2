...
from backend.pages.students.dashboard import register_dashboard_routes
from backend.pages.students.rating import register_rating_board_routes
from backend.pages.students.chat import register_chat_page_routes
from backend.pages.students.resources import register_resources_routes
from backend.pages.students.office_hours import register_office_hours_routes
from backend.services.students.core import (
    get_student_db_id_by_enrollment_id,
    record_student_activity,
)
from backend.services.students.workspace import build_student_panel_context
...
from backend.pages.students.forms import register_student_routes
