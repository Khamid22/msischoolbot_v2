...
from backend.services.parents.core import (
    claim_parent_invite_code,
)
from backend.services.students.core import record_student_activity
from backend.services.teachers.core import get_teacher_by_id
from backend.services.identity.accounts import authenticate_account_password
from backend.services.identity.telegram_auth import authenticate_account_telegram
...
def register_portal_routes(app, *, render_admin_page):
