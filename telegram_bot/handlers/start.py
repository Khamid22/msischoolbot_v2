...
from telegram_bot.keyboards.inline_keyboard import registration_keyboard, student_menu_keyboard
from telegram_bot.settings import settings
from web.backend.routes.students.services.auth_service import record_bot_user
