...
from web.backend.admin.routes.academic_routes import register_academic_admin_routes
from web.backend.admin.routes.admins import register_admin_routes
from web.backend.admin.routes.announcement_routes import register_announcement_admin_routes
from web.backend.admin.routes.chat_admin_routes import register_admin_chat_routes
from web.backend.admin.services.page_service import (
...
from web.backend.admin.services.academic_service import list_admin_academic_context
