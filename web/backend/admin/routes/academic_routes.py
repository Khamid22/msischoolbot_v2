...
from web.backend.admin.routes.request_payload import request_payload
from web.backend.admin.services.page_service import invalidate_admin_page_context_cache
from web.backend.admin.services.academic_service import (
    create_group_from_payload,
    create_schedule_from_payload,
    create_subject_from_payload,
    get_group_gradebook,
...
def register_academic_admin_routes(
    ...
    *,
    ...
    def admin_create_academic_subject():
        try:
            result = create_subject_from_payload(request.form)
        except ValueError as exc:
            return render_admin_page(admin_notice=str(exc), admin_panel="subjects")
        invalidate_admin_page_context_cache()
        return redirect(url_for("student.home", panel="subjects", school=result["school_code"]))
