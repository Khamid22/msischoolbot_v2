...
from web.backend.domains.identity.routes import register_user_auth_routes
from web.backend.roles.parent.routes import build_render_parent_page
from web.backend.roles.student.routes.dashboard import register_dashboard_routes
from web.backend.roles.student.routes.rating_board import register_rating_board_routes
from web.backend.roles.student.routes.chat_page import register_chat_page_routes
...
from web.backend.roles.student.services.page_service import build_student_panel_context
...
from web.backend.roles.student.routes.students import register_student_routes
