...
from web.backend.roles.admin.services.route_service import group_belongs_to_school
from web.backend.utils.session import current_auth_login
from web.backend.roles.admin.services.teacher_candidate_service import (
