...
from web.backend.routes.auth import register_user_auth_routes
from web.backend.routes.parent import build_render_parent_page
from web.backend.student.routes.dashboard import register_dashboard_routes
from web.backend.student.routes.rating_board import register_rating_board_routes
from web.backend.student.routes.chat_page import register_chat_page_routes
from web.backend.student.routes.chat_routes import register_chat_routes
from web.backend.student.routes.comment_routes import register_comment_routes
from web.backend.student.routes.resources import register_resources_routes
from web.backend.student.services.auth_service import (
    get_student_db_id_by_enrollment_id,
    record_student_activity,
)
from web.backend.student.services.page_service import build_student_panel_context
from web.backend.student.services.session_state_service import (
    current_auth_login,
    current_auth_role,
...
from web.backend.student.routes.students import register_student_routes
