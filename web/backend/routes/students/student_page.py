...
from web.backend.routes.user_auth import register_user_auth_routes
from web.backend.routes.students.dashboard import register_dashboard_routes
from web.backend.routes.students.rating_board import register_rating_board_routes
from web.backend.routes.students.chat_page import register_chat_page_routes
from web.backend.routes.students.chat_routes import register_chat_routes
from web.backend.routes.students.comment_routes import register_comment_routes
from web.backend.routes.students.resources import register_resources_routes
...
from web.backend.routes.students.services.page_service import build_student_panel_context
from web.backend.routes.students.services.session_state_service import (
    current_auth_login,
    current_auth_role,
...
from web.backend.routes.students.students import register_student_routes
