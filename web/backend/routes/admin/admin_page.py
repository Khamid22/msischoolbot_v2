...
from web.backend.routes.admin.academic_routes import register_academic_admin_routes
from web.backend.routes.admin.admins import register_admin_routes
from web.backend.routes.admin.announcement_routes import register_announcement_admin_routes
from web.backend.routes.admin.chat_admin_routes import register_admin_chat_routes
from web.backend.routes.admin.services.page_service import (
    build_admin_page_context,
    build_edit_student_page_context,
)
from web.backend.routes.admin.services.session_state_service import (
    current_auth_login,
    current_auth_role,
)
from web.backend.services.academic_admin import list_admin_academic_context
