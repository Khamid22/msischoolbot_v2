...
from web.backend.routes.admin.services.r2_storage_service import upload_resource_file, upload_thumbnail_file
from web.backend.routes.admin.services.resources_service import (
...
from web.backend.routes.admin.services.upload_progress_service import (
    begin_upload,
    complete_upload,
    fail_upload,
    get_upload_events,
